...
prod = int(input("Enter the number of productions: "))

print("Enter the production rules")

for i in range(0, prod):
    prod_rule = input()
    rules.append(prod_rule)


nonterm_userdef = []

non_terminals = int(input("Enter the number of non terminals: "))

for i in range(0, non_terminals):
    nt = input()
    nonterm_userdef.append(nt)


term_userdef = []

terminals = int(input("Enter the number of terminals: "))

for i in range(0, terminals):
    t = input()
    term_userdef.append(t)
